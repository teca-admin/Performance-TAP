        ...
        <table className="text-center border-collapse table-fixed w-full border-spacing-0">
          <thead className="sticky top-0 z-30">
            <tr className="h-[28px] border-none">
              ...
              <th colSpan={group6Count} style={{ width: `${group6Count * colWidth}px` }} className="bg-[#20124d] text-white px-1 text-[10px] font-black uppercase border-r border-[#150b33] border-b-0 whitespace-nowrap overflow-hidden text-ellipsis">6. SAFETY</th>
            </tr>
